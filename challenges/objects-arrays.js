...
*/
const animalNames = zooAnimals.forEach(animal => console.log([`Name: ${animal.animal_name} Scientific: ${animal.scientific_name}`]));
...
*/
const populationTotal = zooAnimals.map(animal => animal.population).reduce((acc, curr) => acc + curr);
